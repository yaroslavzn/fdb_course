    ...
    AuthorizationRoute.name: (routeData) {
      ...
      return _i5.MaterialPageX<dynamic>(
          ...
          child: _i3.AuthorizationPage(
              ...
              onRedirectUrlAttempt: args.onRedirectUrlAttempt));
    },
...
class AuthorizationRoute extends _i5.PageRouteInfo<AuthorizationRouteArgs> {
  AuthorizationRoute(
      ...
      required void Function(Uri) onRedirectUrlAttempt})
      : super(AuthorizationRoute.name,
            path: '/auth',
            args: AuthorizationRouteArgs(
                key: key,
                authorizationUrl: authorizationUrl,
                onRedirectUrlAttempt: onRedirectUrlAttempt));
...
class AuthorizationRouteArgs {
  ...
  final void Function(Uri) onRedirectUrlAttempt;

  @override
  String toString() {
    return 'AuthorizationRouteArgs{key: $key, authorizationUrl: $authorizationUrl, onRedirectUrlAttempt: $onRedirectUrlAttempt}';
  }
}
