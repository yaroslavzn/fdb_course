...
GithubHeaders _$GithubHeadersFromJson(Map<String, dynamic> json) {
  return _GithubHeader.fromJson(json);
}
...
/// @nodoc
abstract class _$$_GithubHeaderCopyWith<$Res>
    implements $GithubHeadersCopyWith<$Res> {
  factory _$$_GithubHeaderCopyWith(
          _$_GithubHeader value, $Res Function(_$_GithubHeader) then) =
      __$$_GithubHeaderCopyWithImpl<$Res>;
  @override
  $Res call({String? etag, PaginationLink? link});
...
/// @nodoc
class __$$_GithubHeaderCopyWithImpl<$Res>
    extends _$GithubHeadersCopyWithImpl<$Res>
    implements _$$_GithubHeaderCopyWith<$Res> {
  __$$_GithubHeaderCopyWithImpl(
      _$_GithubHeader _value, $Res Function(_$_GithubHeader) _then)
      : super(_value, (v) => _then(v as _$_GithubHeader));

  @override
  _$_GithubHeader get _value => super._value as _$_GithubHeader;
...
/// @nodoc
@JsonSerializable()
class _$_GithubHeader extends _GithubHeader {
  const _$_GithubHeader({this.etag, this.link}) : super._();

  factory _$_GithubHeader.fromJson(Map<String, dynamic> json) =>
      _$$_GithubHeaderFromJson(json);
  ...
  @JsonKey(ignore: true)
  @override
  _$$_GithubHeaderCopyWith<_$_GithubHeader> get copyWith =>
      __$$_GithubHeaderCopyWithImpl<_$_GithubHeader>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_GithubHeaderToJson(this);
  }
}

abstract class _GithubHeader extends GithubHeaders {
  const factory _GithubHeader(
      {final String? etag, final PaginationLink? link}) = _$_GithubHeader;
  const _GithubHeader._() : super._();

  factory _GithubHeader.fromJson(Map<String, dynamic> json) =
      _$_GithubHeader.fromJson;
...
class _$_PaginationLink extends _PaginationLink {
  const _$_PaginationLink({this.maxPage}) : super._();
...
abstract class _PaginationLink extends PaginationLink {
  const factory _PaginationLink({final int? maxPage}) = _$_PaginationLink;
