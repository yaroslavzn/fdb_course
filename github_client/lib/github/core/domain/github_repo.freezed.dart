...
abstract class $GithubRepoCopyWith<$Res> {
  ...
  $Res call({User owner, String description, String name, int stargazersCount});
...
class _$_GithubRepo extends _GithubRepo {
  ...
  @override
  String toString() {
    return 'GithubRepo(owner: $owner, description: $description, name: $name, stargazersCount: $stargazersCount)';
  }
