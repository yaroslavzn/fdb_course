...
class _$_LoadInProgress extends _LoadInProgress {
  const _$_LoadInProgress(this.repos, {required this.itemsPerPage}) : super._();
...
abstract class _LoadInProgress extends StarredReposState {
  const factory _LoadInProgress(final Fresh<List<GithubRepo>> repos,
      {required final int itemsPerPage}) = _$_LoadInProgress;
...
class _$_LoadFailure extends _LoadFailure {
  const _$_LoadFailure(this.repos, {required this.failure}) : super._();
...
abstract class _LoadFailure extends StarredReposState {
  const factory _LoadFailure(final Fresh<List<GithubRepo>> repos,
